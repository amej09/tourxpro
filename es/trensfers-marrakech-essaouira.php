                            ...
                            <div class="accordion-item faq-accordion">
                                <h2 class="accordion-header" id="faq-headingOne">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        traslado desde Marrakech to Essaouira
                                    </button>
                                </h2>
                                            ...
                                            <form action="../assets/php/sender.php" id="booking-form">
                                                ...
                                                <div class="contact-form-wrap">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="custom-input-group">
                                                                <label for="destinition">La dirección de destino en Essaouira</label>
                                                                <input type="text" placeholder="su dirección de destino en  Essaouira" name="destinition" id="destinition">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                            ...
                            <div class="accordion-item faq-accordion">
                                <h2 class="accordion-header" id="faq-headingTwo">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        traslado desde Essaouira to Marrakech
                                    </button>
                                </h2>
...
<bold>distancia:</bold> 190Km
<bold>duración:</bold> 2h30
