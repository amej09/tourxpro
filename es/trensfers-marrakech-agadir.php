                    ...
                    <div class="package-details-tabs">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="accordion-item faq-accordion">
                                <h2 class="accordion-header" id="faq-headingOne">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        traslado desde Marrakech OT Agadir
                                    </button>
                                </h2>
                                            ...
                                            <form action="../assets/php/sender.php" id="booking-form">
                                                ...
                                                <div class="contact-form-wrap">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="custom-input-group">
                                                                <label for="destinition">La dirección de destino en Agadir</label>
                                                                <input type="text" placeholder="su dirección de destino en  Agadir" name="destinition" id="destinition">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                            ...
                            <div class="accordion-item faq-accordion">
                                <h2 class="accordion-header" id="faq-headingTwo">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        traslado desde Agadir to Marrakech
                                    </button>
                                </h2>
                            ...
                            <div class="tab-pane fade  package-info-tab mt-3" id="pill-body1" role="tabpanel" aria-labelledby="pills-package1">
                                ...
                                <br>
                                <pre>
Reserve su transporte, durante su estancia en la ciudad de Marrakech, nuestro taxi y minibús están a su disposición para visitar la ciudad de Agadir,
 Podemos unirnos a ustedes en un endoit de su elección.

Agadir se ha transformado de una bonita ciudad del tamaño de una pinta con un aire tranquilo en un lugar lleno de hoteles con encanto para comer, beber y 
divertirse.

 

<bold>distancia:</bold> 259Km
<bold>duración:</bold> 3h50
