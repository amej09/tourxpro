...
<body>
                    ...
                    <div class="col-xl-7 col-lg-8 col-md-8 col-sm-6 col-xs-6">
                        <nav class="main-nav">
                            ...
                            <div class="inner-contact-options d-xl-none">
                                ...
                                <div class="contact-box-inner"><i class="bi bi-envelope-fill"></i> <a href="https://demo.egenslab.com/cdn-cgi/l/email-protection#88e1e6eee7c8edf0e9e5f8e4eda6ebe7e5"><span class="__cf_email__" data-cfemail="98f1f6fef7d8fde0f9f5e8f4fdb6fbf7f5">[email&#160;protected]</span></a></div>
                            </div>
                        </nav>
                    </div>
                    <div class="col-xl-2 col-lg-12 col-md-12 col-sm-12 col-xs-12 align-items-center d-xl-flex d-lg-block">
                        <div class="nav-logo d-flex justify-content-between align-items-center">
                            <a href="index.html"><img src="../assets/images/logo-w.png" alt="logo"></a>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="destination-card-style-two">
                            ...
                            <div class="d-card-content">
                                <h4 class="destination-title"><a href="destination-details.html">Hamburg</a></h4>
                        ...
                        <div class="destination-card-style-two">
                            ...
                            <div class="d-card-content">
                                <h4 class="destination-title"><a href="destination-details.html">Düsseldorf</a></h4>
                                <div class="place-count">
                                    <span>45</span> Place
                                </div>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="destination-card-style-two">
                            ...
                            <div class="d-card-content">
                                <h4 class="destination-title"><a href="destination-details.html">Marakana</a></h4>
                                <div class="place-count">
                                    <span>45</span> Place
                                </div>
                            </div>
                        ...
                        <div class="destination-card-style-two">
                            ...
                            <div class="d-card-content">
                                <h4 class="destination-title"><a href="destination-details.html">Wiesbaden</a></h4>
                                <div class="place-count">
                                    <span>45</span> Place
                                </div>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="destination-card-style-two">
                            ...
                            <div class="d-card-content">
                                <h4 class="destination-title"><a href="destination-details.html">Nuremberg</a></h4>
                                <div class="place-count">
                                    <span>45</span> Place
                                </div>
                            </div>
                        ...
                        <div class="destination-card-style-two">
                            ...
                            <div class="d-card-content">
                                <h4 class="destination-title"><a href="destination-details.html">Chemnitz</a></h4>
                                <div class="place-count">
                                    <span>45</span> Place
                                </div>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="destination-card-style-two">
                            ...
                            <div class="d-card-content">
                                <h4 class="destination-title"><a href="destination-details.html">Bielefeld</a></h4>
                                <div class="place-count">
                                    <span>45</span> Place
                                </div>
                            </div>
                        ...
                        <div class="destination-card-style-two">
                            ...
                            <div class="d-card-content">
                                <h4 class="destination-title"><a href="destination-details.html">Oberhausen</a></h4>
                                <div class="place-count">
                                    <span>45</span> Place
                                </div>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="destination-card-style-two">
                            ...
                            <div class="d-card-content">
                                <h4 class="destination-title"><a href="destination-details.html">Augsburg</a></h4>
                                <div class="place-count">
                                    <span>45</span> Place
                                </div>
                            </div>
    ...
    <div class="newslatter-area newslatter-style-two mt-120">
                ...
                <div class="col-lg-6">
                    <div class="newslatter-offer-side">
                        <div class="newslatter-offer-content">
                            ...
                            <h6>Sign up to receive the best offers on promotion and coupons.
                                Don’t worry! It’s not Spam</h6>
                            <div class="explore-btn">
                                <a href="#" class="button-fill-round">Explore Now</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="newslatter-form-side">
                        <div class="newslatter-form-content">
                            ...
                            <h6>Sign up to receive the best offers on promotion and coupons.
                                Don’t worry! It’s not Spam</h6>
                            <form action="#" method="post" id="newslatter-forem2">
                                <div class="newslatter-form-wrap">
    ...
    <div class="package-area offer-package-style-one pt-110">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="section-head-gamma">
                            ...
                            <div class="row g-4">
                                <div class="col-lg-4 col-md-6">
                                    <div class="package-card-alpha">
                                        ...
                                        <div class="package-card-body">
                                            <h3 class="p-card-title"><a href="package-details.html">Etiam placerat
                                                    dictum consequat an
                                ...
                                <div class="col-lg-4 col-md-6 ">
                                    <div class="package-card-alpha">
                                        ...
                                        <div class="package-card-body">
                                            <h3 class="p-card-title"><a href="package-details.html">varius condimentum
                                                    consequat frin
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="package-card-alpha">
                                        ...
                                        <div class="package-card-body">
                                            <h3 class="p-card-title"><a href="package-details.html">Praesent sed elit
                                                    mi. In risus nullaam
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="package-card-alpha">
                                        ...
                                        <div class="package-card-body">
                                            <h3 class="p-card-title"><a href="package-details.html">Sed ultricies sapien
                                                    arcu, sed cong
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="package-card-alpha">
                                        ...
                                        <div class="package-card-body">
                                            <h3 class="p-card-title"><a href="package-details.html">Pellentesque
                                                    habitant morbi malesua
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="package-card-alpha">
                                        ...
                                        <div class="package-card-body">
                                            <h3 class="p-card-title"><a href="package-details.html">San Francisco Golden
                                                    Gate Bridge, cable cars & fog.</a></h3>
                                            <div class="p-card-bottom">
                                                <div class="book-btn">
                                                    <a href="package-details.html">Book Now <i class='bx bxs-right-arrow-alt'></i></a>
                                                </div>
    ...
    <div class="world-map-area mt-110">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-head-gamma">
            ...
            <div class="world-map-wrap">
                <div class="world-map-background">
                    <img src="../assets/images/banner/map-bg.png" alt="">
                </div>
                <div class="single-location location-1">
                    <div class="location-icon">
                        <i class="bi bi-geo-alt-fill"></i>
                    </div>
                    <div class="location-disc">
                        <h6>United States</h6>
                        <p>Sed rhoncus eros eu est faucibuses rhoncus. In lobortis, ex sit ametend ultricies blandit,
                            dui arcu conguepor urna eu ultricies metus.</p>
                    </div>
                </div>
                <div class="single-location location-2">
                    <div class="location-icon">
                        <i class="bi bi-geo-alt-fill"></i>
                    </div>
                    <div class="location-disc">
                ...
                <div class="single-location location-3">
                    <div class="location-icon">
                        <i class="bi bi-geo-alt-fill"></i>
                    </div>
                    <div class="location-disc">
                ...
                <div class="single-location location-4">
                    <div class="location-icon">
                        <i class="bi bi-geo-alt-fill"></i>
                    </div>
                    <div class="location-disc">
                ...
                <div class="single-location location-5">
                    <div class="location-icon">
                        <i class="bi bi-geo-alt-fill"></i>
                    </div>
                    <div class="location-disc">
    ...
    <div class="testimonial-area testimonial-style-two pt-110 pb-110">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-head-gamma">
                        <h2 class="text-white">What Our Travelar Say</h2>
                    </div>
                </div>
            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-card-gamma mx-auto">
                                    <div class="testimonial-quote-icon">
                                        <img src="../assets/images/icons/qoute-icon.svg" class="img-fluid" />
                                    </div>
                                        ...
                                        <div class="testimonial-info">
                                            <div class="reviewr-info">
                                                <div class="single-thumb">
                                                    <img src="../assets/images/reviewer/testti-thumb1.png" alt="">
                                                </div>
                                                <div class="reviwer-info-cotn">
                                                    <h5 class="reviewer-name">Jims Pull</h5>
                                                    <p>Traveller</p>
                                                </div>
                                            </div>
                                ...
                                <div class="testimonial-card-gamma mx-auto">
                                    ...
                                    <div class="testimonial-card-body">
                                        ...
                                        <div class="testimonial-info">
                                            <div class="reviewr-info">
                                                <div class="single-thumb">
                                                    <img src="../assets/images/reviewer/testti-thumb2.png" alt="">
                                                </div>
                                                <div class="reviwer-info-cotn">
                                                    <h5 class="reviewer-name">Shwan Pull</h5>
                                                    <p>Traveller</p>
                                                </div>
                                            </div>
                                            <ul class="reviewer-rating gap-2">
                                    ...
                                    <div class="testimonial-card-body">
                                        ...
                                        <div class="testimonial-info">
                                            <div class="reviewr-info">
                                                ...
                                                <div class="reviwer-info-cotn">
                                                    <h5 class="reviewer-name">Mixis Pull</h5>
                                                    <p>Traveller</p>
                                                </div>
                                            </div>
                                            <ul class="reviewer-rating gap-2">
    ...
    <div class="blog-area blog-style-two pt-110">
        <div class="container">
            <div class="row">
                <div class="col-lg-7">
                ...
                <div class="col-lg-5">
                    <div class="blog-btn text-lg-end"><a href="blog.html" class="button-fill-round">View All</a></div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="blog-card-gamma">
                        ...
                        <div class="blog-content">
                            ...
                            <h4 class="blog-title"><a href="blog-details.html">vitae tempor convallis, mi ligula an
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-card-gamma">
                        ...
                        <div class="blog-content">
                            ...
                            <h4 class="blog-title"><a href="blog-details.html">Nulla urna leo, volutpat eu maurisa eget
