...
<html lang="en">
    ...
    <div class="breadcrumb breadcrumb-style-one">
        <div class="container">
            <div class="col-lg-12 text-center">
                <h2 class="breadcrumb-title">Marrakech Desert Buggy Tour :  </h2>
                    ...
                    <div class="tour-package-details">
                        <div class="pd-header">
                            ...
                            <div class="header-bottom">
                                ...
                                <h2 class="pd-title">Marrakech Desert Buggy Tour Including Berber Tea Break and transfer</h2>
                            </div>
                        </div>
                    </div>    
                </div>
 ...
 Go off the beaten track and explore Morocco’s rugged desert landscapes by all-terrain quad bike on this adventure excursion. Swap the 
 hustle and bustle of city for the solitude and beauty of the desert, motoring with your guide along dusty trails under the shadow of 
 soaring mountain peaks. Eenjoy vistas of arid riverbeds, natural palm groves, and primordial volcanic terrain, plus take a break for M
 oroccan tea and snack with a local family in a Berber village.

Tour Duration: 4 hours
Availability: Every day

    <i class='bx bx-check'></i>  Quad bike tour in the desert: Escape the city hustle and bustle
    <i class='bx bx-check'></i>  Explore desert valleys and traditional Berber villages
    <i class='bx bx-check'></i> Hassle-free pickup and drop-off from your Marrakech hotel
    <i class='bx bx-check'></i> Enjoy a pot of Moroccan tea and a snack with a local family

What is included?

    <i class='bx bx-check'></i> Hotel pickup and drop-off
    <i class='bx bx-check'></i> Professional guide
    <i class='bx bx-check'></i> Safety briefing
    <i class='bx bx-check'></i> Use of buggy, helmet, gloves and goggles
    <i class='bx bx-check'></i> Bottled water
    <i class='bx bx-check'></i> Tea and snack

What is NOT included? 
    <i class='bx bx-check'></i> Gratuities
    <i class='bx bx-check'></i> Food and drinks, unless specified
