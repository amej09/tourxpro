                    ...
                    <div class="package-details-tabs">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="accordion-item faq-accordion">
                                <h2 class="accordion-header" id="faq-headingTwo">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        Departure from Agadir --> Menara airport
                                    </button>
                                </h2>
                            ...
                            <div class="accordion-item faq-accordion">
                                <h2 class="accordion-header" id="faq-headingThree">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        Arrival and departure, Marrakech - Agadir
                                    </button>
                                </h2>
                                                ...
                                                <div class="contact-form-wrap">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                                ...
                                                                <div class="custom-input-group">
                                                                    <label for="destinationadresse">The destination address in Agadir</label>
                                                                    <input type="text" placeholder="Your destination address in Agadir" name="destinationadresse" id="destinationadresse">
                                                                </div>
                            ...
                            <div class="tab-pane fade  package-info-tab mt-3" id="pill-body1" role="tabpanel" aria-labelledby="pills-package1">
                                ...
                                <br>
                                <pre>
Book your Transport, during your stay in the city marrakech, our TAXI and Minibus are at your disposal to visit the city of Agadir,
 we can join you in a endoit of your choice.

Agadir has been transformed from a pretty city the size of a pint with a quiet air into a place full of charming hotels to eat, drink and 
have fun.
