                            ...
                            <div class="accordion-item faq-accordion">
                                <h2 class="accordion-header" id="faq-headingTwo">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        Departure from Fès - Menara airport
                                    </button>
                                </h2>
                            ...
                            <div class="accordion-item faq-accordion">
                                <h2 class="accordion-header" id="faq-headingThree">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        Arrival and departure, Marrakech - Fès
                                    </button>
                                </h2>
                                                ...
                                                <div class="contact-form-wrap">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                                ...
                                                                <div class="custom-input-group">
                                                                    <label for="destinationadresse">The destination address in Fès</label>
                                                                    <input type="text" placeholder="Your destination address in Fès" name="destinationadresse" id="destinationadresse">
                                                                </div>
