                ...
                <div class="tour-package-details">
                    ...
                    <div class="package-details-tabs">
                        ...
                        <li class="nav-item navmargin" role="reservation">
                                <button class="nav-link active" id="pills-package2" data-bs-toggle="pill" data-bs-target="#pill-body2" type="button" role="tab" aria-controls="pill-body2" aria-selected="true"><i class="bi bi-info-lg"></i> Reservation</button>
                            </li>
