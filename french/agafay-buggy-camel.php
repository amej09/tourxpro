    ...
    <div class="breadcrumb breadcrumb-style-one">
        <div class="container">
            <div class="col-lg-12 text-center">
                <h2 class="breadcrumb-title">Aventure Buggy au Désert d'Agafay   </h2>
                    ...
                    <div class="tour-package-details">
                        <div class="pd-header">
                            ...
                            <div class="header-bottom">
                                ...
                                <h2 class="pd-title">Aventure Buggy au Désert d'Agafay </h2>
                            </div>
                        </div>
                    </div>    
                </div>
...
Partez à l’aventure, en randonnée Buggy sur les terres sauvages d’Agafay et du lac Lalla Takerkoust

Cette excursion en Buggy vous permet de s’immerger dans un décor lunaire et de goûter aux paradoxes du désert. Source de dépaysement à proximité de Marrakech, elle vous fera traverser l’immensité d’un paysage aride avant de parvenir à une luxuriante Oasis… tout en découvrant les contreforts de l’Atlas et en allongeant le Lac de Takerkoust.

Après 45 min de route, accueil des participants et remise des équipements (gants, casques, cheichs, lunettes), un briefing sur l’utilisation, la sécurité et l’usage des buggys sera assuré par des professionnels vigilants et attentifs…

Vous suivrez les pistes de pierres du désert d’Agafay et ses collines arides, la sensation d’être seul au monde vous saisira dans ce paysage lunaire. Arrêt sur le « Plateau » pour avoir un panorama extraordinaire sur le lac artificiel d’une longueur de 7km dont les eaux bleues s’étalent jusqu’au pied de l’Atlas, savourez un bon thé à la menthe dans une tente traditionnelle berbère.

À votre retour en direction de Marrakech, profitez de vues époustouflantes sur l’Atlas.

* Nos prix sont par Buggy, 1 Buggy peut être réservé pour 1 ou 2 personnes

* Cette excursion est accessible aux personnes âgées de plus de 14 ans
Les enfants moins de 14 ans peuvent joindre cette expérience en tant que passagers

Durée : 3 - 4 heures
Tour en Buggy : 2 heures
Distance: 30 km x 2
