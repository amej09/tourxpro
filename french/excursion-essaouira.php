...
<?php include('template/header.php')?>
    ...
    <div class="breadcrumb breadcrumb-style-one">
        <div class="container">
            <div class="col-lg-12 text-center">
                <h2 class="breadcrumb-title"> Excursion Essaouira - Mogador  </h2>
                        ...
                        <div class="pd-header">
                            ...
                            <div class="header-bottom">
                                <div class="pd-lavel d-flex justify-content-between align-items-center flex-wrap gap-2">
                                    <h5 class="location"><i class="bi bi-geo-alt"></i> essaouira, maroc</h5>
                                ...
                                <h2 class="pd-title">Excursion Essaouira - Mogador</h2>
                            </div>
                        </div>
                    </div>    
                </div>
 ...
 Essaouira fut découverte par les Phéniciens qui s'y installèrent. Puis ce fut conquis par Rome et par le Portugal. Avant la fin du 15ème siècle, les Portugais avaient construit le port commercial et militaire de Mogador (Essaouira aujourd'hui). Ce port est situé aux pieds des remparts de la ville.  

Depuis la terrasse du bastion Nord, vous avez accès au quartier de la marquèterie où les meilleurs artisans travaillent le cèdre. En quittant la Skala, nous suivons la rue Derb Laalouj jusqu'au musée Sidi Mohammed Ben Mohammed Ben Abdallah où se trouve une collection d'instruments de musique pour les chansons andalouses locales, d'armes, de costumes... Situé au nord de la ville se trouve le Mellah, le quartier Juif qui croise la traditionnelle rue Mohammed Zerktouni. Un marché le borde qui s'étend jusqu'à Bab Doukkala…

Déjeuner poissons (spécialités d'Essaouira) dans un restaurant en bord de mer.

En route nous traverserons de nombreux champs d'Arganiers, arbres donnant les noix qui serviront à la fabrication de la fameuse huile d'Argan utilisée aussi bien en cuisine que pour les produits cosmétiques. Vous aurez la chance de voir les chèvres perchées sur les arganiers… Et visite d’une vraie coopérative des femmes qui produisant la véritable huile d’Argan.

    Activités en option pour l’excursion en privée :
        Balade en Quad sur des terrains variés : dunes, foret… (2 heures)
        Balade en chameau sur la plage d’Essaouira (1 heure)
