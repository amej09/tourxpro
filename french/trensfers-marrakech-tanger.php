...
<div class="breadcrumb breadcrumb-style-one">
    <div class="container">
        <div class="col-lg-12 text-center">
            <h2 class="breadcrumb-title">Marrakech <--> Tanger </h2>
                    ...
                    <div class="package-details-tabs">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="accordion-item faq-accordion">
                                <h2 class="accordion-header" id="faq-headingOne">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        Transfert de Marrakech à Tanger
                                    </button>
                                </h2>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="custom-input-group">
                                                                ...
                                                                <input type="text" placeholder="Ton nom complet" id="name">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="custom-input-group">
                                                                <label for="passenger">Nombre de passagers</label>
                                                                <input type="number" placeholder="Nombre de passagers" id="passenger" min="0" max="5">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="custom-input-group">
                                                                ...
                                                                <input type="date" placeholder=" Your Date d'arrivée" id="arrival">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="custom-input-group">
                                                                <label for="timearrival">Heure d'arrivée</label>
                                                                <input type="time" placeholder="Your Heure d'arrivée" id="timearrival">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="custom-input-group">
                                                                ...
                                                                <input type="text" placeholder="Your Numéro de vol d'arrivée" id="flightnumber">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="custom-input-group">
                                                                <label for="destinition">The destination address in Tanger</label>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="custom-input-group">
                                                                ...
                                                                <input type="text" placeholder="Votre numéro de téléphone" id="Phone">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="custom-input-group">
                                                        <textarea cols="20" rows="7" placeholder="Votre message"></textarea>
                                                    </div>
                                                    <div class="custom-input-group">
                                                        <div class="submite-btn">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="custom-input-group">
                                                                ...
                                                                <input type="date" placeholder=" Your Date de départ" id="departure">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="custom-input-group">
                                                                <label for="timedeparture">Heure de départ</label>
                                                                <input type="time" placeholder="Your Heure de départ" id="timedeparture">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="custom-input-group">
                                                                ...
                                                                <input type="text" placeholder="Your Numéro du vol de départ" id="flightnumber">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="custom-input-group">
                                                                <label for="pickupadresse">Adresse du point de retrait</label>
                                                                <input type="text" placeholder="Your Adresse du point de retrait" id="pickupadresse">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                            ...
                            <div class="tab-pane fade  package-info-tab mt-3" id="pill-body1" role="tabpanel" aria-labelledby="pills-package1">
                                ...
                                <br>
                                <pre>
                                Vous venez pour quelques jours à Marrakech en famille ou entre amis, notre agence de transport touristique à Marrakech vous garantit 
services locaux de qualité et au meilleur prix possible :)
Pour réussir votre voyage, votre agence de transport touristique à marrakech s’occupe de tous vos voyages au sein de Marrakech ou de 
cette ville et à toutes les destinations de votre choix dans les meilleures conditions. Fes, Essaouira, Casablanca, Ouarzazat, Rabat...

Vous arrivez ou partez de Marrakech Menara Aéroport, quel que soit le moment et le lieu, notre agence vous propose un séjour confortable, fiable et ponctuel 
service de navette sans attente, sans perdre de temps à un prix raisonnable et défini à l’avance par un simple contact.

 

<bold>Distance :</bold> 575 km
<bold>Durée :</bold> 6h00
                            ...
                            <div class="tab-pane fade package-gallary-tab mt-3" id="pill-body3" role="tabpanel" aria-labelledby="pills-package3">
                                ...
                                <div class="col-6">
                                        <div class="package-gallary-item">
                                            <img src="../assets/images/transfers/tanger1.jpg" alt="">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="package-gallary-item">
                                            <img src="../assets/images/transfers/tanger2.jpg" alt="">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="package-gallary-item">
                                            <img src="../assets/images/transfers/tanger3.jpg" alt="">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="package-gallary-item">
                                    ...
                                    <div class="col-6">
                                        <div class="package-gallary-item">
                                            <img src="../assets/images/transfers/tanger4.jpg" alt="">
                                        </div>
                                    </div>
                                    
                                    <div class="col-6">
                                        <div class="package-gallary-item">
                                            <img src="../assets/images/transfers/tanger5.jpg" alt="">
                                        </div>
                                    </div>
