...
<div class="breadcrumb breadcrumb-style-one">
    <div class="container">
        <div class="col-lg-12 text-center">
            <h2 class="breadcrumb-title">Marrakech Menara Aéroport <--> Marrakech </h2>
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <table class="table" style="color: black;">
                                ...
                                <tr>
                                    ...
                                    <td>Transfert Aéroport De/Vers guiliz ou mdina</td>
                                    <td>15 Euro</td>
                                ...
                                <tr>
                                    ...
                                    <td>Transfert Aéroport De/Vers Palmeraie</td>
                                    <td>20 Euro</td>
                            ...
                            <div class="accordion-item faq-accordion">
                                <h2 class="accordion-header" id="faq-headingOne">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        Arrivée à Marrakech - Menara Aéroport
                                    </button>
                                </h2>
                                        ...
                                        <div class="container mt-20">
                                            <form action="../assets/php/sender.php" id="booking-form">
                                                ...
                                                <div class="contact-form-wrap">
                                                    <h5><i class="bi bi-airplane"></i>Aéroport <bold>--></bold><i class="bi bi-house"></i>Hotel/Riad</h5>
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="custom-input-group">
                            ...
                            <div class="accordion-item faq-accordion">
                                <h2 class="accordion-header" id="faq-headingTwo">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        Départ de Marrakech - Menara Aéroport
                                    </button>
                                </h2>
                            ...
                            <div class="accordion-item faq-accordion">
                                <h2 class="accordion-header" id="faq-headingThree">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        Arrivée et départ, Marrakech - Menara Aéroport
                                    </button>
                                </h2>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                                ...
                                                                <div class="custom-input-group">
                                                                    ...
                                                                    <input type="text" placeholder="Your destination address in Marrakech" name="destinationadresse" id="destinationadresse">
                                                                </div>
                            ...
                            <div class="tab-pane fade  package-info-tab mt-3" id="pill-body1" role="tabpanel" aria-labelledby="pills-package1">
                                ...
                                <br>
                                <pre>
                                Laissez-nous nous soucier des détails de votre transport, vous permettant le temps de penser à d’autres détails.

Si vous vous rendez à l’Aéroport, vous pouvez compter sur notre service de voiture pour venir vous chercher où que vous soyez à Marrakech et vous rendre à l’Aéroport à temps pour votre vol.
...
Tous nos chauffeurs se présenteront avec un panneau de bienvenue sur lequel apparaîtra votre nom ainsi que celui de votre organisation d’appartenance, si vous ne souhaitez pas que votre nom apparaisse, veuillez nous le faire savoir à l’avance afin que notre chauffeur puisse vous identifier avec le panneau de "Traces Berbères Voyages".

Si vous êtes à la recherche d’un chauffeur professionnel et prudent pour vous emmener à ou depuis l’Aéroport, ce service est exactement ce dont vous avez besoin. Détendez-vous et assurez-vous que le début ou la fin de votre séjour à Marrakech est entre de bonnes mains.

Que vous voyagiez pour affaires ou pour le plaisir, vous serez transporté vers ou depuis l’aéroport de Marrakech-Menara vers votre destination, en toute sécurité et confort.

Arrivée Transfert depuis l’Aéroport : Votre chauffeur vous attendra dans le hall de l’Aéroport, avec un panneau mentionnant votre nom. Si votre vol est en retard, ne vous inquiétez pas, le chauffeur vous attendra jusqu’à votre arrivée. Ensuite, vous serez conduit à votre hôtel

Départ Transfert à l’Aéroport : Le chauffeur viendra vous chercher à votre hôtel ou Riad à Marrakech à l’heure convenue et il s’assurera que vous atteignez l’Aéroport au moins deux heures avant le vol de départ afin d’avoir suffisamment de temps pour l’enregistrement des bagages.

Transfert Aéroport-Hôtel (Arrivée & Départ) : Si vous souhaitez profiter d’un transport facile et confortable pendant votre séjour à Marrakech, réservez un service de navette privé pour vos transferts de et vers l’Aéroport, vous serez conduit à votre destination à temps et en toute sécurité.

 

<bold>Distance :</bold> Entre 10 et 15 km
<bold>Durée :</bold> 20 min
<bold>Disponibilité:</bold> All days
                            ...
                            <div class="tab-pane fade package-gallary-tab mt-3" id="pill-body3" role="tabpanel" aria-labelledby="pills-package3">
                                ...
                                <div class="col-6">
                                        <div class="package-gallary-item">
                                            <img src="../assets/images/transfers/marrakech_menara_Aéroport_1.jpg" alt="">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="package-gallary-item">
                                            <img src="../assets/images/transfers/marrakech_menara_Aéroport_2.jpg" alt="">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="package-gallary-item">
                                            <img src="../assets/images/transfers/marrakech_menara_Aéroport_3.jpg" alt="">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="package-gallary-item">
