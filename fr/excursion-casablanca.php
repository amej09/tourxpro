...
<html lang="en">
    ...
    <div class="breadcrumb breadcrumb-style-one">
        <div class="container">
            <div class="col-lg-12 text-center">
                <h2 class="breadcrumb-title">Excursion vers Casablanca   </h2>
                        ...
                        <div class="pd-header">
                            ...
                            <div class="header-bottom">
                                <div class="pd-lavel d-flex justify-content-between align-items-center flex-wrap gap-2">
                                    <h5 class="location"><i class="bi bi-geo-alt"></i> casablanca, maroc</h5>
                                ...
                                <h2 class="pd-title">Excursion vers Casablanca  </h2>
                            </div>
                        </div>
                    </div>    
                </div>
 ...
 Départ de Marrakech vers la capitale économique du Maroc à 7h00, Casablanca qui signifient littéralement « la maison blanche », faisant référence aux ruines d'une maison blanchie à la chaux qui servait un point de repère aux marins ibériques qui naviguaient dans les parages. Casablanca est  une métropole stupéfiante, variée de tradition et d'ultra modernisme, elle a hérité un riche patrimoine art-déco.

Etape 1 : Mosquée Hassan II

Première étape de la découverte de la capitale économique du Maroc, la majestueuse mosquée Hassan II, deuxième plus grande mosquée du mondeouverte aux non-musulmans, cette mosquée est absolument extraordinaire : plus haut minaret du monde musulman, plus grand espace de prière d’Afrique, et véritable symbole de la ville. Un mélange de techniques modernes et de savoir-faire antique marocain. Elle offrira une superbe visite !

Etape 2 : Ancienne médina

Ensuite le souk de la médina Bab Marrakech c’est l’ancienne médina entourée par des remparts

Considéré comme le quartier le plus vieux de la métropole, Bab Marrakech a été créé au XX° siècle. On y trouve aussi de charmants petits hôtels qui datent de l'époque du protectorat,elle est très agréable et permet de découvrir la vie quotidienne des habitants

Etape 3 : Place des nations unis
...
Ce qui n’est pas inclus:
    ...
    <i class='bx bx-check'></i>Frais d’entrée à la Mosquée Hassan II
