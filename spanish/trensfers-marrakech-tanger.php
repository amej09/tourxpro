                            ...
                            <div class="accordion-item faq-accordion">
                                <h2 class="accordion-header" id="faq-headingOne">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        traslado desde  Marrakech to Tanger
                                    </button>
                                </h2>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="custom-input-group">
                                                                ...
                                                                <input type="text" placeholder="tu nombre completo" id="name">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="custom-input-group">
                                                                <etiqueta para="pasajero">Número de pasajero</etiqueta>
                                                                <input type="number" placeholder="Número de pasajero" id="passenger" min="0" max="5">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="custom-input-group">
                                                                ...
                                                                <input type="date" placeholder=" su fecha de llegada" id="arrival">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="custom-input-group">
                                                                <label for="timearrival">Hora de llegada</label>
                                                                <input type="time" placeholder="Su Hora de llegada" id="timearrival">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="custom-input-group">
                                                                ...
                                                                <input type="text" placeholder="Su Número de vuelo de llegada" id="flightnumber">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="custom-input-group">
                                                                <label for="destinition">La dirección de destino en Tanger</label>
                                                                <input type="text" placeholder="su dirección de destino en  Marrakech" id="destinition">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="custom-input-group">
                                                                ...
                                                                <input type="text" placeholder="Su número de teléfono" id="Phone">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="custom-input-group">
                                                        <textarea cols="20" rows="7" placeholder="Tu mensajee"></textarea>
                                                    </div>
                                                    <div class="custom-input-group">
                                                        <div class="submite-btn">
                            ...
                            <div class="accordion-item faq-accordion">
                                <h2 class="accordion-header" id="faq-headingTwo">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        traslado desde Tanger - Marrakech
                                    </button>
                                </h2>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="custom-input-group">
                                                                ...
                                                                <input type="date" placeholder=" Su fecha de salida" id="departure">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="custom-input-group">
                                                                <label for="timedeparture">Hora de salida</label>
                                                                <input type="time" placeholder="Su hora de salida" id="timedeparture">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="custom-input-group">
                                                                ...
                                                                <input type="text" placeholder="Su número de vuelo de salida" id="flightnumber">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="custom-input-group">
                                                                <label for="pickupadresse">Dirección del punto de recogida</label>
                                                                <input type="text" placeholder="Su dirección de punto de recogida" id="pickupadresse">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
...
<bold>distancia:</bold> 575Km
<bold>duración:</bold> 6h00
